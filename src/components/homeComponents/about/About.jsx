            ...
            <div className="py-14 flex justify-center lg:justify-start">
              <div className="group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30">
                <div className=" h-full ">
                  <img
                    className="h-full w-full max-w-md  object-cover transition-transform duration-500 group-hover:rotate-3 group-hover:scale-125"
                ...
                <div className="absolute inset-0 flex translate-y-[60%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
                  <p className="mb-3 text-3xl font-bold font-mono text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">
