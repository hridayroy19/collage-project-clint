...
const Contact = () => {
  return (
    ...
    <div className="relative  border-2 w-full">
      ...
      {/* text section */}
      <div className="absolute bg-white p-4 shadow-white shadow-2xl xl:top-[90%]  md:top-[80%] top-[500px]  left-1/2 transform -translate-x-1/2 -translate-y-1/2">
        <div className="flex flex-col md:flex-row bg-base-100 gap-4 w-full ">
          ...
          <div className="px-2 -top-32 py-1 xl:w-[500px] w-[320px] md:w-[90%] lg:w-[400px]">
